...
const LEVEL_BACKGROUNDS = {
  1: "niveau1_arcade.jpg",
  2: "niveau2_entrepot.jpg",
  3: "niveau3_ville_pluie.jpg",
  4: "niveau4_desert.jpg",
  5: "niveau5_station_spatiale.jpg",
  6: "niveau6_montagne.jpg",
  7: "niveau7_jungle.jpg",
  8: "niveau8_labo.jpg",
  9: "niveau9_ruines.jpg",
  10: "niveau10_neon.jpg",
};
...
function clearLines() {
  ...
  if (cleared > 0) {
    lines += cleared;
    score += cleared * 100;
    level = Math.min(10, Math.floor(lines / 5) + 1);
...
function updateBackground() {
  const imageName = LEVEL_BACKGROUNDS[level] || LEVEL_BACKGROUNDS[1];
  bgLayer.style.backgroundImage = `url("${imageName}")`;
}
...
function moveLeft() {
  if (!isRunning) return;
  currentX--;
  if (collides(board, currentPiece, currentX, currentY)) currentX++;
  draw();
}
